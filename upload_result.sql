...
('Studi Banding & Kunjungan Kampus 2024', 'pendidikan', '2024', 'Studi banding bersama delegasi mahasiswa se-Indonesia ke kampus dan perusahaan teknologi.', '["https://uuybelgxovlgozgizith.supabase.co/storage/v1/object/public/portofolio/dummy/gallery_campus.png"]')
ON CONFLICT DO NOTHING;

-- PROJECT with real images
...
-- ARTICLE with real images
INSERT INTO "Article" (title, slug, content, excerpt, "imageUrl", category, published, "createdAt") VALUES
('Memulai Karir sebagai Full Stack Developer di Usia Muda', 'memulai-karir-fullstack', '## Pendahuluan

Memulai karir di bidang teknologi di usia muda bukanlah hal yang mustahil. Dengan tekad kuat dan strategi belajar yang tepat, siapapun bisa menjadi developer handal.

## Langkah Pertama

Mulailah dari dasar: HTML, CSS, JavaScript. Jangan langsung loncat ke framework sebelum menguasai fondasinya.', 'Panduan lengkap bagi pemuda yang ingin memulai karir sebagai full stack developer dari nol.', 'https://uuybelgxovlgozgizith.supabase.co/storage/v1/object/public/portofolio/dummy/blog_career.png', 'Karir', true, NOW()),
('Supabase vs Firebase: Mana yang Lebih Cocok?', 'supabase-vs-firebase', '## Perbandingan

Dua platform BaaS populer ini memiliki kelebihan masing-masing. Supabase berbasis PostgreSQL dan open-source, sementara Firebase dari Google dengan NoSQL.', 'Analisis lengkap kelebihan dan kekurangan Supabase vs Firebase untuk project modern.', 'https://uuybelgxovlgozgizith.supabase.co/storage/v1/object/public/portofolio/dummy/blog_tech.png', 'Teknologi', true, NOW() - INTERVAL ''3 days''),
('Belajar Next.js 14 dari Nol untuk Pemula', 'belajar-nextjs-14', '## Apa itu Next.js?

Next.js adalah framework React yang memungkinkan server-side rendering, static generation, dan banyak fitur production-ready out of the box.', 'Tutorial step-by-step belajar Next.js 14 dengan App Router untuk pemula absolut.', 'https://uuybelgxovlgozgizith.supabase.co/storage/v1/object/public/portofolio/dummy/blog_tech.png', 'Tutorial', true, NOW() - INTERVAL ''7 days''),
('Pentingnya Soft Skill bagi Seorang Developer', 'softskill-penting-developer', '## Developer Lebih dari Sekadar Coding

Komunikasi, manajemen waktu, dan kemampuan berkolaborasi adalah soft skill yang sering diremehkan namun sangat krusial.', 'Mengapa komunikasi dan kepemimpinan sama pentingnya dengan kemampuan coding.', 'https://uuybelgxovlgozgizith.supabase.co/storage/v1/object/public/portofolio/dummy/blog_career.png', 'Karir', true, NOW() - INTERVAL ''14 days''),
('Membangun Portofolio Digital yang Menarik', 'membangun-portofolio-digital', '## Mengapa Portofolio Penting?

Portofolio adalah wajah profesional kamu di dunia digital. Ini yang pertama dilihat klien atau recruiter sebelum memutuskan untuk menghubungimu.', 'Cara membangun portofolio digital yang profesional dan meninggalkan kesan mendalam.', 'https://uuybelgxovlgozgizith.supabase.co/storage/v1/object/public/portofolio/dummy/blog_career.png', 'Personal', true, NOW() - INTERVAL ''21 days''),
('Tips Time Management untuk Mahasiswa Aktif', 'tips-time-management-mahasiswa', '## Tantangan Mahasiswa Aktif

Menjadi aktif di organisasi sambil menjaga IPK adalah tantangan nyata. Berikut strategi yang telah terbukti efektif.', 'Strategi manajemen waktu yang efektif bagi mahasiswa yang aktif berorganisasi.', 'https://uuybelgxovlgozgizith.supabase.co/storage/v1/object/public/portofolio/dummy/blog_tech.png', 'Lifestyle', true, NOW() - INTERVAL ''28 days'')
ON CONFLICT (slug) DO NOTHING;