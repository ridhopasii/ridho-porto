...
function initScrollAnimations() {
    ...
    document.querySelectorAll('.reveal, .tech-card, .project-card').forEach(el => {
        el.style.opacity = '0';
...
function showNotification(message, type = 'info') {
    ...
    notification.className = `fixed top-24 right-4 px-6 py-4 rounded-xl text-white font-medium z-50 transform translate-x-full transition-transform duration-300 ${
        type === 'success' ? 'bg-accent text-primary' : 'bg-secondary border border-white/10'
    }`;
