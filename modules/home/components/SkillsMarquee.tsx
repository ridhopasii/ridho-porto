...
export default function SkillsMarquee({ skills }: SkillsMarqueeProps) {
  ...
  return (
    <div className="relative w-full overflow-hidden py-4 space-y-4">
      ...
      <div className="pointer-events-none absolute left-0 top-0 bottom-0 w-16 bg-gradient-to-r from-neutral-50 to-transparent dark:from-neutral-950 z-10" />
      <div className="pointer-events-none absolute right-0 top-0 bottom-0 w-16 bg-gradient-to-l from-neutral-50 to-transparent dark:from-neutral-950 z-10" />
