...
const BlogList = ({ articles, publications = [] }: BlogListProps) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="w-full max-w-md rounded-xl bg-neutral-100 p-1 dark:bg-neutral-800/80 flex gap-1">
        ...
        >
          {t("tab_publications") || "Publikasi Eksternal"}
        </button>
      </div>
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between border-b border-neutral-200 dark:border-neutral-800 pb-5">
        ...
        {/* Category Filter Pills (Only visible when articles tab is active) */}
        {activeTab === "articles" && (
                  ...
                  <Link href={pub.url || "#"} target={pub.url ? "_blank" : ""} className="flex flex-col h-full">
                    ...
                    <div className="relative aspect-[16/10] w-full overflow-hidden bg-neutral-100 dark:bg-neutral-900">
                      {pub.imageUrl ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-violet-500/10 to-cyan-500/10 dark:from-violet-500/5 dark:to-cyan-500/5 text-neutral-400">
                          <span className="text-xs uppercase tracking-[0.3em] font-light text-violet-500 dark:text-violet-400">
                            Publication
                          </span>
                        </div>
                      )}
                    ...
                    <div className="flex flex-col justify-between flex-1 p-5 space-y-3">
                      <div className="space-y-2">
                        ...
                        {/* Description */}
                        <p className="text-xs text-neutral-500 dark:text-neutral-400 line-clamp-3 leading-relaxed font-light">
                          {pub.description || "Karya tulis, jurnal ilmiah, atau publikasi eksternal."}
                        </p>
                      </div>

                      {/* Footer Details */}
                      <div className="flex items-center justify-between pt-3 border-t border-neutral-100 dark:border-neutral-900 text-[11px] text-neutral-400 dark:text-neutral-500 font-light font-mono">
