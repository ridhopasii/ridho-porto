      ...
      <main className="flex-1 p-8 overflow-y-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            {experiences?.map((exp) => (
              <div key={exp.id} className="p-6 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-between group hover:border-teal-500/30 transition-all">
            ...
            {experiences?.length === 0 && <p className="text-gray-600 italic">Belum ada data pengalaman kerja.</p>}
          </div>
        </div>
      </main>
    </div>
