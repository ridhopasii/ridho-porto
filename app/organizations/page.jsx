    ...
    <div className="min-h-screen bg-background text-foreground font-jakarta selection:bg-teal-500/30">
      ...
      <section className="pt-32 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          <Link href="/" className="inline-flex items-center gap-2 text-teal-500 text-xs font-bold uppercase tracking-widest mb-8 hover:gap-4 transition-all">
          ...
          <h1 className="text-5xl md:text-8xl font-black font-outfit tracking-tighter uppercase mb-6 leading-none flex items-center gap-4">
            <Users className="text-teal-500 w-12 h-12 md:w-20 md:h-20" /> Organisasi.
          </h1>
