      ...
      <div className="flex-1 flex items-center justify-center px-6 py-32">
        <div className="text-center max-w-2xl mx-auto">
          ...
          <div className="relative mb-12">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="space-y-4 text-center">
                <div className="w-16 h-16 rounded-[2rem] bg-teal-500/10 border border-teal-500/20 flex items-center justify-center mx-auto">
                  <Search size={32} className="text-teal-500" />
                </div>
                <p className="text-teal-500 text-sm font-black uppercase tracking-[0.4em]">
          ...
          <h1 className="text-3xl md:text-5xl font-black font-outfit uppercase tracking-tighter mb-6">
            Ups! Halaman ini <span className="text-teal-500">Hilang</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/"
              className="px-10 py-5 bg-teal-500 text-black font-black rounded-2xl hover:bg-teal-400 transition-all hover:scale-105 flex items-center justify-center gap-2 text-sm uppercase tracking-widest shadow-xl shadow-teal-500/20"
            >
