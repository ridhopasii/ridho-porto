  ...
  return (
    <div className="min-h-screen bg-body text-foreground p-10 font-jakarta">
      ...
      <div className="grid gap-6">
        ...
        {/* Detail Data */}
        {profile ? (
          <div className="p-6 bg-white/5 border border-[var(--border-subtle)] rounded-2xl border-accent/30">
            <p className="text-accent font-bold mb-2">✅ Data Berhasil Dibaca!</p>
