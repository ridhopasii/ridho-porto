            ...
            <div className="space-y-12 relative before:absolute before:left-[27px] before:top-2 before:bottom-2 before:w-[2px] before:bg-white/5">
              {experiences?.map((exp) => (
                <div key={exp.id} className="relative pl-20 group">
                  <div className="absolute left-0 top-0 w-14 h-14 bg-[#0a0a0a] border border-white/10 rounded-2xl flex items-center justify-center z-10 group-hover:border-blue-500/50 transition-all">
                    <div className="w-2 h-2 bg-blue-500 rounded-full group-hover:scale-150 transition-all" />
                  </div>

                  <div className="p-8 bg-white/5 border border-white/10 rounded-3xl group-hover:bg-white/[0.08] transition-all">
                    ...
                    <h3 className="text-xl font-black text-white uppercase mb-1">{exp.role}</h3>
            ...
            <div className="space-y-12 relative before:absolute before:left-[27px] before:top-2 before:bottom-2 before:w-[2px] before:bg-white/5">
              {educations?.map((edu) => (
                <div key={edu.id} className="relative pl-20 group">
                  <div className="absolute left-0 top-0 w-14 h-14 bg-[#0a0a0a] border border-white/10 rounded-2xl flex items-center justify-center z-10 group-hover:border-indigo-500/50 transition-all">
                  ...
                  <div className="p-8 bg-white/5 border border-white/10 rounded-3xl group-hover:bg-white/[0.08] transition-all">
                    ...
                    <h3 className="text-xl font-black text-white uppercase mb-1">{edu.degree}</h3>
