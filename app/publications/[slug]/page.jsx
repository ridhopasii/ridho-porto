        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
          <div className="lg:col-span-2 space-y-12">
            <section className="relative">
              <Quote size={48} className="absolute -top-6 -left-6 text-foreground/5" />
                ...
                <div className="pt-4 space-y-4">
                  {pub.url && (
                    <a
                      href={pub.url}
                      target="_blank"
                      className="flex items-center justify-between p-4 bg-blue-500 text-foreground rounded-2xl font-black text-[10px] uppercase tracking-widest hover:scale-105 transition-all shadow-lg shadow-blue-500/20"
                    >
                      Read Full Text <BookOpen size={16} />
                    </a>
                  )}
                  <button className="w-full flex items-center justify-between p-4 bg-white/5 border border-[var(--border-subtle)] text-foreground rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-white/10 transition-all">
