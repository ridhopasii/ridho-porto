    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full bg-[#1a1a1a] border border-[var(--border-subtle)] rounded-xl px-4 py-3 text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50"
        ...
        <div className="space-y-4">
          <label className="text-sm font-medium text-gray-400 uppercase tracking-widest flex items-center gap-2">
            <ImageIcon size={14} className="text-accent" /> Galeri Foto Artikel
          </label>
          <MultiPhotoUpload
      ...
      <div>
        ...
        <textarea
          ...
          className="mt-1 block w-full bg-[#1a1a1a] border border-[var(--border-subtle)] rounded-xl px-4 py-3 text-foreground font-mono focus:outline-none focus:ring-2 focus:ring-accent/50"
