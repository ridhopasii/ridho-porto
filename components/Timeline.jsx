        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
          ...
          <div className="animate-fade-in-up">
            <div className="flex items-center gap-4 mb-12">
              ...
              <h2 className="text-3xl font-black font-outfit uppercase tracking-tight">Experience</h2>
            </div>
            ...
            <div className="space-y-12 relative before:absolute before:left-8 before:top-0 before:bottom-0 before:w-px before:bg-white/10">
              ...
              {experiences?.length === 0 && <p className="text-gray-600 italic pl-10">Belum ada data pengalaman.</p>}
            </div>
          </div>
          ...
          <div className="animate-fade-in-up animation-delay-2000">
            <div className="flex items-center gap-4 mb-12">
              ...
              <h2 className="text-3xl font-black font-outfit uppercase tracking-tight">Education</h2>
            </div>
            ...
            <div className="space-y-12 relative before:absolute before:left-8 before:top-0 before:bottom-0 before:w-px before:bg-white/10">
              ...
              {educations?.length === 0 && <p className="text-gray-600 italic pl-10">Belum ada data pendidikan.</p>}
            </div>
          </div>
